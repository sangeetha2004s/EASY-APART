...
<body>
    ...
    <img src="admin.jpg" alt="Background Image" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; z-index: -1;">

    <div id="login-box">
        <h2 id="form-title">ADMIN LOGIN</h2>
        <form action="newlogin3.php" method="post" id="login">
